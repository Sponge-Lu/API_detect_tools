...
| 文件 | 描述 |
|------|------|
| `themePresets.ts` | 4 套主题预设、主题模式类型、存储键和模式归一化工具 |
| `FOLDER_INDEX.md` | 本文件 |

## 关键内容

- 主题模式：`light-a`、`light-b`、`light-c`、`dark`
- 兼容旧值：`light`、`system` 等旧存储值会归一化为新的浅色默认主题
...
- 2026-03-31: 创建四主题预设层，支撑 UI 重设计中的 `3 浅色 + 1 暗色` 方案
