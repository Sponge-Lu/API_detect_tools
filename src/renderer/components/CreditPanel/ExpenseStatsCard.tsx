    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-[var(--text-primary)]">支出统计</span>
          {dailyStats && (
              ...
              return (
                <div key={index} className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span
                      className={`font-medium ${hasValue ? 'text-[var(--danger)]' : 'text-[var(--text-secondary)]'}`}
                    >
                      {formatDailyExpense(item.expense)}
                    </span>
                  </div>
                  {/* 水平条形 */}
                  <div className="h-2.5 overflow-hidden rounded-full bg-[var(--danger-soft)]">
                    {hasValue ? (
                      <div
